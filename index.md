...
# Final Milestone
My final milestone was the hardware part of the project. For this milestone, I constructed the frame, put all of the components inside the frame, and added my finishing touches to the mirror. For the frame, I had to cut the wood and attach the pieces using an assortment of wood glue and different screws. I also stained the frame white. Then, I had to put all of the parts into the frame. I put the clear plastic first, then the mirror acrylic, then the monitor, and finally I drilled the monitor into place. With this milestone, I enjoyed working with the handsaw and drill. These are tools I was not familiar with, so I enjoyed working with them. I struggled with correctly measuring the dimensions of the frame because I had to account for the extra space. I had tried to build a frame, but the dimensions were way too small, so I had to scrap it and start again. 
